...
@Component({
  selector: 'oasis-donate-seeds',
  standalone: true,
  imports: [CommonModule],
  template: `
    <div class="mf-shell">
      <div class="mf-header"><span>🌱</span><h2 class="mf-title">Donate Seeds</h2></div>
      <div class="mf-body">
        <div class="mf-field"><label class="mf-lbl">Recipient Avatar</label><input class="mf-inp" placeholder="Recipient Avatar..." /></div>
        <div class="mf-field"><label class="mf-lbl">Amount</label><input class="mf-inp" placeholder="Amount..." /></div>
        <div class="mf-field"><label class="mf-lbl">Organization</label><input class="mf-inp" placeholder="Organization..." /></div>
        <div class="mf-field"><label class="mf-lbl">Note</label><input class="mf-inp" placeholder="Note..." /></div>
        <div class="mf-field"><label class="mf-lbl">Reference</label><input class="mf-inp" placeholder="Reference..." /></div>
      </div>
      <div class="mf-footer">
...
export class DonateSeedsComponent {
  @Input() show = false;
