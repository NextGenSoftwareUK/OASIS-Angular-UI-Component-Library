...
@Component({
  selector: 'oasis-manage-seeds',
  standalone: true,
  imports: [CommonModule],
  template: `
    <div class="mf-shell">
      <div class="mf-header"><span>⚙️</span><h2 class="mf-title">Manage Seeds</h2></div>
      <div class="mf-body">
        <div class="mf-field"><label class="mf-lbl">Seeds Account No</label><input class="mf-inp" placeholder="Seeds Account No..." /></div>
        <div class="mf-field"><label class="mf-lbl">Default Provider</label><input class="mf-inp" placeholder="Default Provider..." /></div>
        <div class="mf-field"><label class="mf-lbl">Auto-Plant Setting</label><input class="mf-inp" placeholder="Auto-Plant Setting..." /></div>
        <div class="mf-field"><label class="mf-lbl">Min Balance Alert</label><input class="mf-inp" placeholder="Min Balance Alert..." /></div>
        <div class="mf-field"><label class="mf-lbl">Notifications</label><input class="mf-inp" placeholder="Notifications..." /></div>
      </div>
      <div class="mf-footer">
...
export class ManageSeedsComponent {
  @Input() show = false;
