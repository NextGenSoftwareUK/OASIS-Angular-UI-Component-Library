...
@Component({
  selector: 'oasis-reward-seeds',
  standalone: true,
  imports: [CommonModule],
  template: `
    <div class="mf-shell">
      <div class="mf-header"><span>🏆</span><h2 class="mf-title">Reward Seeds</h2></div>
      <div class="mf-body">
        <div class="mf-field"><label class="mf-lbl">Avatar to Reward</label><input class="mf-inp" placeholder="Avatar to Reward..." /></div>
        <div class="mf-field"><label class="mf-lbl">Amount</label><input class="mf-inp" placeholder="Amount..." /></div>
        <div class="mf-field"><label class="mf-lbl">Reason</label><input class="mf-inp" placeholder="Reason..." /></div>
        <div class="mf-field"><label class="mf-lbl">Quest/Mission Reference</label><input class="mf-inp" placeholder="Quest/Mission Reference..." /></div>
      </div>
      <div class="mf-footer">
...
export class RewardSeedsComponent {
  @Input() show = false;
