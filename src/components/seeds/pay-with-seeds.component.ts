...
@Component({
  selector: 'oasis-pay-with-seeds',
  standalone: true,
  imports: [CommonModule],
  template: `
    <div class="mf-shell">
      <div class="mf-header"><span>💰</span><h2 class="mf-title">Pay with Seeds</h2></div>
      <div class="mf-body">
        <div class="mf-field"><label class="mf-lbl">Recipient</label><input class="mf-inp" placeholder="Recipient..." /></div>
        <div class="mf-field"><label class="mf-lbl">Amount</label><input class="mf-inp" placeholder="Amount..." /></div>
        <div class="mf-field"><label class="mf-lbl">Memo</label><input class="mf-inp" placeholder="Memo..." /></div>
...
export class PayWithSeedsComponent {
  @Input() show = false;
