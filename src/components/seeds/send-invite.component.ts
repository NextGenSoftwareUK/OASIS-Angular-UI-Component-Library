...
@Component({
  selector: 'oasis-send-invite',
  standalone: true,
  imports: [CommonModule],
  template: `
    <div class="mf-shell">
      <div class="mf-header"><span>✉️</span><h2 class="mf-title">Send Invite</h2></div>
      <div class="mf-body">
        <div class="mf-field"><label class="mf-lbl">Recipient Name</label><input class="mf-inp" placeholder="Recipient Name..." /></div>
        <div class="mf-field"><label class="mf-lbl">Email Address</label><input class="mf-inp" placeholder="Email Address..." /></div>
        <div class="mf-field"><label class="mf-lbl">Personalised Message</label><input class="mf-inp" placeholder="Personalised Message..." /></div>
        <div class="mf-field"><label class="mf-lbl">Seeds Bonus Amount</label><input class="mf-inp" placeholder="Seeds Bonus Amount..." /></div>
      </div>
      <div class="mf-footer">
