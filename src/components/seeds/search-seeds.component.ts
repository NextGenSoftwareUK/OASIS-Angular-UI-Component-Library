...
@Component({
  selector: 'oasis-search-seeds',
  standalone: true,
  imports: [CommonModule, FormsModule],
  template: `
    <div class="sf-shell">
      <div class="sf-header"><span>🔍</span><h2 class="sf-title">Search Seeds</h2></div>
      <div class="sf-row"><input class="sf-input" [(ngModel)]="query" placeholder="Search by avatar or transaction ID..." (keyup.enter)="search()" /><button class="sf-btn" (click)="search()">Search</button></div>
...
export class SearchSeedsComponent {
  @Input() show = false;
