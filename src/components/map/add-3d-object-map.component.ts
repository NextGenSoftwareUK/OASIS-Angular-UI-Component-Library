...
@Component({
  selector: 'oasis-add-3d-object-map',
  standalone: true,
  imports: [CommonModule],
  template: `
    <div class="mf-shell">
      <div class="mf-header"><span>🌐</span><h2 class="mf-title">Add 3D Object to Map</h2></div>
      <div class="mf-body">
        ...
        <div class="mf-field"><label class="mf-lbl">Z Position</label><input class="mf-inp" placeholder="Z Position..." /></div>
        <div class="mf-field"><label class="mf-lbl">Scale</label><input class="mf-inp" placeholder="Scale..." /></div>
        <div class="mf-field"><label class="mf-lbl">Model URL</label><input class="mf-inp" placeholder="Model URL..." /></div>
      </div>
      <div class="mf-footer">
...
export class Add3dObjectMapComponent {
  @Input() show = false;
