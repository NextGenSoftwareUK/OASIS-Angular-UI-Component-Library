...
@Component({
  selector: 'oasis-add-quest-to-map',
  standalone: true,
  imports: [CommonModule],
  template: `
    <div class="mf-shell">
      <div class="mf-header"><span>⚔️</span><h2 class="mf-title">Add Quest to Map</h2></div>
      <div class="mf-body">
        <div class="mf-field"><label class="mf-lbl">Quest Name</label><input class="mf-inp" placeholder="Quest Name..." /></div>
        <div class="mf-field"><label class="mf-lbl">Location X</label><input class="mf-inp" placeholder="Location X..." /></div>
        <div class="mf-field"><label class="mf-lbl">Location Y</label><input class="mf-inp" placeholder="Location Y..." /></div>
        <div class="mf-field"><label class="mf-lbl">Radius</label><input class="mf-inp" placeholder="Radius..." /></div>
...
export class AddQuestToMapComponent {
  @Input() show = false;
