...
@Component({
  selector: 'oasis-plot-route-on-map',
  standalone: true,
  imports: [CommonModule],
  template: `
    <div class="mf-shell">
      <div class="mf-header"><span>📍</span><h2 class="mf-title">Plot Route on Map</h2></div>
      <div class="mf-body">
        <div class="mf-field"><label class="mf-lbl">Route Name</label><input class="mf-inp" placeholder="Route Name..." /></div>
        <div class="mf-field"><label class="mf-lbl">Start Location</label><input class="mf-inp" placeholder="Start Location..." /></div>
        <div class="mf-field"><label class="mf-lbl">End Location</label><input class="mf-inp" placeholder="End Location..." /></div>
        <div class="mf-field"><label class="mf-lbl">Waypoints</label><input class="mf-inp" placeholder="Waypoints..." /></div>
...
export class PlotRouteOnMapComponent {
  @Input() show = false;
